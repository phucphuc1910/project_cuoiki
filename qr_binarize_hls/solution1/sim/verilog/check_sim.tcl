...
proc check_tvin_file {} {
    ...
    set rtlfilelist {
         "c.qr_binarize.autotvin_src_V_data_V.dat"
         "c.qr_binarize.autotvin_src_V_keep_V.dat"
         "c.qr_binarize.autotvin_src_V_strb_V.dat"
         "c.qr_binarize.autotvin_src_V_last_V.dat"
         "c.qr_binarize.autotvin_threshold.dat"
         "c.qr_binarize.autotvin_invert.dat"
         "c.qr_binarize.autotvin_size.dat"
    }
...
proc check_tvout_file {} {
    ...
    set rtlfilelist {
         "rtl.qr_binarize.autotvout_dst_V_data_V.dat"
         "rtl.qr_binarize.autotvout_dst_V_keep_V.dat"
         "rtl.qr_binarize.autotvout_dst_V_strb_V.dat"
         "rtl.qr_binarize.autotvout_dst_V_last_V.dat"
    }
    foreach rtlfile $rtlfilelist {
        if {[file isfile $rtlfile]} {
        } else {
