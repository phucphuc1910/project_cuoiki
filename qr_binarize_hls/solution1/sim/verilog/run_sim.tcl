...
if {[file isfile qr_binarize.autotvin.dat]} {
	file delete -force qr_binarize.autotvin.dat
}

if {[file isfile qr_binarize.autotvout.dat]} {
	file delete -force qr_binarize.autotvout.dat
}
