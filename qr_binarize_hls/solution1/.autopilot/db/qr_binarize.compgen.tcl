...
if {${::AESL::PGuard_simmodel_gen}} {
	if {[info proc ::AESL_LIB_XILADAPTER::s_axilite_gen] == "::AESL_LIB_XILADAPTER::s_axilite_gen"} {
		eval "::AESL_LIB_XILADAPTER::s_axilite_gen { \
			id 19 \
			corename qr_binarize_CTRL_axilite \
			name qr_binarize_CTRL_s_axi \
			ports {$port_CTRL} \
			op interface \
...
if {${::AESL::PGuard_rtl_comp_handler}} {
	::AP::rtl_comp_handler qr_binarize_CTRL_s_axi BINDTYPE interface TYPE interface_s_axilite
}
...
eval "::AESL_LIB_XILADAPTER::native_axis_add { \
    ...
    metadata {  } \
    op interface \
    ports { src_TVALID { I 1 bit } src_TREADY { O 1 bit } src_TLAST { I 1 vector } } \
} "
} else {
...
eval "::AESL_LIB_XILADAPTER::native_axis_add { \
    ...
    metadata {  } \
    op interface \
    ports { dst_TVALID { O 1 bit } dst_TREADY { I 1 bit } dst_TLAST { O 1 vector } } \
} "
} else {
...
# RegSlice definition:
set ID 28
set RegSliceName qr_binarize_regslice_both
set RegSliceInstName qr_binarize_regslice_both_U
set CoreName ap_simcore_qr_binarize_regslice_both
if {${::AESL::PGuard_rtl_comp_handler}} {
