set moduleName qr_binarize_Pipeline_VITIS_LOOP_21_1
set isTopModule 0
...
set hasInterrupt 0
set C_modelName {qr_binarize_Pipeline_VITIS_LOOP_21_1}
...
set C_modelArgMapList {[ 
	{ "Name" : "size", "interface" : "wire", "bitwidth" : 32, "direction" : "READONLY"} , 
 	...
 	{ "Name" : "invert", "interface" : "wire", "bitwidth" : 1, "direction" : "READONLY"} , 
...
set portList { 
	...
	{ threshold sc_in sc_lv 8 signal 5 } 
	{ invert sc_in sc_lv 1 signal 6 } 
	{ sub_i_i sc_in sc_lv 33 signal 7 } 
...
set NewPortList {[ 
	{ "name": "ap_clk", "direction": "in", "datatype": "sc_logic", "bitwidth":1, "type": "clock", "bundle":{"name": "ap_clk", "role": "default" }} , 
 	...
 	{ "name": "invert", "direction": "in", "datatype": "sc_lv", "bitwidth":1, "type": "signal", "bundle":{"name": "invert", "role": "default" }} , 
...
set PerformanceInfo {[
	{"Name" : "Latency", "Min" : "90005", "Max" : "90005"}
	, {"Name" : "Interval", "Min" : "90005", "Max" : "90005"}
]}
...
set Spec2ImplPortList { 
	...
	invert { ap_none {  { invert in_data 0 1 } } }
