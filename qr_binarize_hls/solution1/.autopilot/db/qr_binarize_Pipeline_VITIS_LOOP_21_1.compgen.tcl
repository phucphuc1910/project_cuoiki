...
set name qr_binarize_mul_8ns_9ns_16_1_1
...
set id 2
set name qr_binarize_mac_muladd_8ns_7ns_16ns_16_4_1
...
set id 3
set name qr_binarize_mac_muladd_8ns_5ns_16ns_16_4_1
set corename simcore_mac
set op mac
set stage_num 4
set clk_width 1
...
eval "::AESL_LIB_XILADAPTER::native_axis_add { \
    ...
    metadata {  } \
    op interface \
    ports { src_TVALID { I 1 bit } src_TDATA { I 32 vector } } \
} "
} else {
...
eval "::AESL_LIB_XILADAPTER::native_axis_add { \
    ...
    metadata {  } \
    op interface \
    ports { dst_TREADY { I 1 bit } dst_TDATA { O 8 vector } } \
} "
} else {
...
set InstName qr_binarize_flow_control_loop_pipe_sequential_init_U
set CompName qr_binarize_flow_control_loop_pipe_sequential_init
