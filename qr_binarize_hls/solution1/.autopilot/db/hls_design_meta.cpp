...
const Port_Property HLS_Design_Meta::port_props[]={
	...
	Port_Property("src_TDATA", 32, hls_in, 0, "axis", "in_data", 1),
	Port_Property("src_TVALID", 1, hls_in, 3, "axis", "in_vld", 1),
	Port_Property("src_TREADY", 1, hls_out, 3, "axis", "in_acc", 1),
	Port_Property("src_TKEEP", 4, hls_in, 1, "axis", "in_data", 1),
	Port_Property("src_TSTRB", 4, hls_in, 2, "axis", "in_data", 1),
...
const char* HLS_Design_Meta::dut_name = "qr_binarize";
