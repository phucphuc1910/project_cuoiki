...
/* Definitions for driver QR_BINARIZE */
#define XPAR_XQR_BINARIZE_NUM_INSTANCES 1

/* Definitions for peripheral QR_BINARIZE_0 */
#define XPAR_QR_BINARIZE_0_DEVICE_ID 0
#define XPAR_QR_BINARIZE_0_S_AXI_CTRL_BASEADDR 0x40000000
#define XPAR_QR_BINARIZE_0_S_AXI_CTRL_HIGHADDR 0x4000FFFF


/******************************************************************/

/* Canonical definitions for peripheral QR_BINARIZE_0 */
#define XPAR_XQR_BINARIZE_0_DEVICE_ID XPAR_QR_BINARIZE_0_DEVICE_ID
#define XPAR_XQR_BINARIZE_0_S_AXI_CTRL_BASEADDR 0x40000000
#define XPAR_XQR_BINARIZE_0_S_AXI_CTRL_HIGHADDR 0x4000FFFF
